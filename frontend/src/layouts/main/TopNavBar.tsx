...
export function TopNavBar() {
  ...
  const userAvatarMenuItems: MenuProps['items'] = [
    {
      key: 'profile',
      label: isHR ? 'HR Dashboard' : 'My Profile',
      icon: isHR ? <DashboardOutlined /> : <UserOutlined />,
      onClick: () => {
    ...
    >
      <div
        ...
        style={{
          ...
          maxWidth: 1400,
          margin: '0 auto',
          paddingInline: screens.xl ? 40 : screens.lg ? 24 : 16,
          display: 'flex',
          alignItems: 'center',
